...
| **CURRENT_TURN_DIRECTORY** | Directory where this turn’s artifacts (template-changelog, ADR, manifest, etc.) are written.                                                                                                                                    | `${TARGET_PROJECT}/ai/agentic-pipeline/turns/${TURN_ID}` |
...
| **Variable**                 | **Description**                                                                                                           | **Path / Resolution Rule**                               |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| **TEMPLATES**                | Root directory for all reusable templates used by the agentic pipeline. Contains governance, PR, ADR, and turn templates. | `${AGENTIC_PIPELINE_PROJECT}/agentic-pipeline/templates` |
| **TEMPLATE_METADATA_HEADER** | Template for metadata headers placed at the top of all source files.                                                      | `${TEMPLATES}/governance/metadata_header.txt`            |
...
| **TEMPLATE_CHANGELOG**       | Template used to record the change log, file additions, and turn summary.                                                 | `${TEMPLATES}/turn/template-changelog.md`                |
